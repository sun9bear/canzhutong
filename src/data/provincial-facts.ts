...
export const PROVINCIAL_PATCHES: Record<string, ExtraPatch> = {
  ...
  GD: {
    ...
    extraPolicies: [
      localSubsidy({
        ...
        eligibility:
          "广东省符合两项补贴条件的持证残疾人，对象范围仍按国发〔2015〕52号及省实施办法。",
  ...
  SC: {
    ...
    planUrl:
      "http://www.scdpf.org.cn/zwgk/ghjh/202302/t20230220_31172.html",
    planIssued: "2022-03-07（川府发〔2022〕9号，省残联官网转载省政府通知全文）",
    rehabUrl:
      "https://www.sc.gov.cn/10462/zfwjts/2022/11/7/ecca8fb33ff84dfb83a155f66fdd018d.shtml",
    rehabAgeNote:
      "原川府发〔2018〕40号已于2025-12-31失效。现行省级依据含川府规〔2022〕6号《四川省〈残疾预防和残疾人康复条例〉实施办法》（省政府网站公开全文，标注继续有效至2027-12-07）：优先开展残疾儿童康复工作、落实残疾儿童康复救助制度；县级以上政府对0—6岁残疾儿童除基本医疗保险报销外的基本康复费用按规定给予补助；有条件的地区可以适当放宽残疾儿童救助范围、提高救助标准。具体项目、年龄放宽与补助额度以省残联配套及户籍地最新公开办法为准，本库不锁死金额。",
    implementingUrl:
