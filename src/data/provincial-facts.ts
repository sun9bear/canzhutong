...
export const PROVINCIAL_PATCHES: Record<string, ExtraPatch> = {
  ...
  FJ: {
    ...
    subsidyPoints: [
      "福建省财政厅2025年1月公开：自2025年1月起，生活补贴121元/月；护理补贴一级145元/月、二级121元/月。市县可高于省标准（如福清等地公示更高）。2026年是否再调，请核省民政厅最新通知。",
    ],
    extraPolicies: [
      localSubsidy({
        id: "fj-subsidy-2025",
  ...
  YN: {
    ...
    subsidyPoints: [
      "云民发〔2026〕2号：自2026年1月1日起，省级指导标准为困难残疾人生活补贴100元/人/月，重度残疾人护理补贴一级110元/人/月、二级100元/人/月。",
      "由每人每月90/100/90元分别提高。州（市）可高于省级指导标准。",
    ],
    extraPolicies: [
      localSubsidy({
        id: "yn-subsidy-2026",
        ...
        keyPoints: [
          ...
          "此为省级指导标准，昆明安宁等地2026年公示与此一致。",
        ],
        eligibility:
          "云南省符合两项补贴条件的持证残疾人，对象范围以省通知和州（市）审核为准。",
        howToApply: "向户籍地乡镇街道申请。",
        body: "依据《云南省民政厅 云南省财政厅 云南省残疾人联合会关于调整残疾人两项补贴标准的通知》（云民发〔2026〕2号）。牟定县人民政府网2026年3月11日问答完整引用该文金额。安宁市民政局2026年4月发放公示执行同一标准。",
        sourceName: "云民发〔2026〕2号（牟定县人民政府网转引）",
        sourceUrl: "https://www.mdx.gov.cn/info/2982/344825.htm",
        docNo: "云民发〔2026〕2号",
        issuedAt: "2026-01",
        effectiveAt: "2026-01-01",
      }),
  ...
  XJ: {
    ...
    subsidyPoints: [
      "新民发〔2026〕20号：自2026年1月1日起，全区困难残疾人生活补贴和重度残疾人护理补贴基础标准均由120元/人/月提高至140元/人/月。",
      "地州可按此执行或上浮。吐鲁番、博尔塔拉、克孜勒苏等地2026年公示与此一致。",
    ],
    extraPolicies: [
      localSubsidy({
        id: "xj-subsidy-2026",
  ...
  JX: {
    ...
    subsidyPoints: [
      "赣府发〔2025〕5号：从2025年1月起，困难残疾人生活补贴和重度残疾人护理补贴均由100元/人/月提高到110元/人/月。",
      "黎川县2026年6月统计表、龙南县2026年4月公开仍按110元执行。市县是否上浮以当地文件为准。",
    ],
    extraPolicies: [
      localSubsidy({
        id: "jx-subsidy-2025",
