  ...
  return (
    <div className="min-h-dvh bg-bg">
      ...
      <main
        id="main"
        tabIndex={-1}
        className="flex min-h-dvh w-full items-center justify-center bg-bg px-4 py-10"
      >
              ...
              <form className="space-y-3" onSubmit={(e) => void onEmail(e)}>
                ...
                <label className="block text-sm">
                  ...
                  <Input
                    ...
                    minLength={8}
                    autoComplete={
                      signupEnabled && mode === "up" ? "new-password" : "current-password"
                    }
                    value={password}
